...
                  if
                    not currentDropDown.bnetIDAccount or not _CanGroupWithAccount(currentDropDown.bnetIDAccount) or
                      isInGroupWithPlayer
                   then
                    enable = false
                  end
...
      if
        accountInfo and accountInfo.gameAccountInfo.gameAccountID and not accountInfo.gameAccountInfo.isInCurrentRegion and
...
       then
        local areaName =
          accountInfo.gameAccountInfo.isWowMobile and LOCATION_MOBILE_APP or
          (accountInfo.gameAccountInfo.areaName or UNKNOWN)
